...
class MobileNetV2(nn.Module):
    def __init__(self, cfg):
        ...
        self.stages = ["in"+str(input_channel), "in16", "in24x2","in32x3", "in64x4",
                       "in96x3", "in160x3", "in320",
                      "in"+str(last_channel)]
        self.return_features = ["in24x2", "in32x3", "in96x3", self.stages[-1]]
        ...
        self.add_module(self.stages[0], ConvBNReLU(3, input_channel, stride=2))
        ...
        for idx, (t, c, n, s) in enumerate(inverted_residual_setting):
            ...
            self.add_module(self.stages[idx+1], nn.Sequential(*features))
        # building last several layers
        self.add_module(self.stages[-1], ConvBNReLU(input_channel, self.last_channel, kernel_size=1))
    ...
    def forward(self, x):
        ...
        for stage_name in self.stages:
            ...
            if stage_name in self.return_features:
                outputs.append(x)
        return outputs
